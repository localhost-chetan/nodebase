...
const messages: ChatCompletionMessageParam[] = [
    {
        role: "system", content: `
                ROLE => You're an helpful assistant who have access to the web search tool if you don't have the data.
...
export const toolCaller = async () => {
    ...
    for (const tool of toolCalls) {
        ...
        console.log("🚀 ~ toolCaller.ts:99 ~ toolCaller ~ final: ", final.choices.at(0)?.message.content);
